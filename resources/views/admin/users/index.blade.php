                            ...
                            @if ($customer->customer->status == "accepted")
                              <td style="width:2em;">
                                <form action="{{ url('admin/solicitudes') }}" method="post" enctype="multipart/form-data" >
                                    ...
                                    <button type="submit" style="border:0px;background-color:white;"><i style="color:rgb(255, 0, 0);cursor: pointer;" class="trash-icon tf-icons bx bx-block"></i></button>
                                </form>
                              </td>
