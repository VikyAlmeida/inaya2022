...
@endif
<div class="section type-1 section-contact"style="margin-top: 5em;margin-bottom:0; height:150%;">
    <div class="container">
      ...
      <form role="form"  method="POST" action="{{ url('/customer/misLocales/store') }}" role="form" enctype="multipart/form-data">
          @csrf
        <div class="form-group">
          <div class="row">
              <div class="col-lg-6">
                    <label for="">Nombre del local</label>
                    <input type="text" name="name" id="" class="form-control" placeholder="Nombre del local"/>
                    @error('name')
            ...
            <div class="col-lg-6">
                <div class="row" style="margin-bottom:1em;">
                    <div class="col-lg-12">
                        ...
                        <input type="text" name="tlf" class="form-control" style="width: 94%; margin-left:1em;" >
                        @error('tlf')
                            <span class="invalid-feedback" role="alert"style="width: 94%; margin-left:1em;">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="row" style="margin-bottom:-1em;">
                    <div class="col-lg-12">
                        ...
                        <textarea name="details" id="" cols="30" rows="9"style="width: 94%; margin-left:1em;" class="form-control"></textarea>
                        @error('details')
                            <span class="invalid-feedback" role="alert"style="width: 94%; margin-left:1em;">
                                <strong>{{ $message }}</strong>
                            </span>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <input type="checkbox" name="SMS" id=""><br>
            </div>
        </div>
        <div class="row">
