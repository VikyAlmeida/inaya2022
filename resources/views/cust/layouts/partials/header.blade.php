                  ...
                  @elseif(auth()->user()->type == 'admin')
                    <li>
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="{{ url('/home') }}">Mis publicaciones</a></li>
                        <li><hr class="dropdown-divider"></li>
                        <li>
                          <a class="dropdown-item" href="{{ route('logout') }}"
                              onclick="event.preventDefault();
                    ...
                    <li>
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="{{ url('/home') }}">Tus publicacion</a></li>
                        <li><a class="dropdown-item" href="{{ url('/home') }}">Tus favoritos</a></li>
                        <li><hr class="dropdown-divider"></li>
                        <li>
                          <a class="dropdown-item" href="{{ route('logout') }}"
                              onclick="event.preventDefault();
